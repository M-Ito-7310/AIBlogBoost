    ...
    <div v-if="finalArticle" class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 mb-6">
      ...
      <div class="space-y-1 text-sm">
        ...
        <div v-if="finalArticle.keywords.length > 0" class="mt-2">
          <p class="font-semibold text-gray-600 dark:text-gray-300 mb-1">元キーワード:</p>
        ...
        <div v-if="finalArticle.seoKeywords && finalArticle.seoKeywords.length > 0" class="mt-3">
          <p class="font-semibold text-gray-600 dark:text-gray-300 mb-1 flex items-center">
          ...
          <div class="flex flex-wrap gap-1">
            <span
              v-for="keyword in finalArticle.seoKeywords"
              :key="keyword"
              class="text-xs bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 px-2 py-1 rounded border border-green-200 dark:border-green-700"
            >
              {{ keyword }}
            </span>
          </div>
